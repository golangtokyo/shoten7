...
@<code>{Ops}は@<code>{Reset}メソッドを使って中身をクリアすることができるので、何度も使い回すことが推奨されます。
...
=== layoutをうまく利用する
@<code>{gioui.org/ui/layout}はGioの薄いライブラリの中にあって、かなり自由な画面構成を作ることができます。
...
== Gioへのコントリビュート
Gioへ興味が湧いてきて、色々使っているとバグをみつけたり、修正したいことが出てくると思います。
そう思ったらぜひ積極的にコントリビュートしていきましょう。
//}
#@# textlint-enable
